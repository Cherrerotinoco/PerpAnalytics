...
export const FilterBar = memo(
  ({ panels, visible, onToggle, onToggleSection, onApplyPreset }: FilterBarProps) => {
      ...
      <>
        ...
        <div className="tc-filter-bar" ref={barRef} role="toolbar" aria-label="Dashboard filters">
          ...
          <div className="tc-filter-reset tc-filter-dropdown">
            ...
            {presetOpen && (
              <div
                className="tc-filter-menu tc-filter-menu--right"
                role="menu"
        ...
        >
          ...
          {hiddenCount > 0 && <span className="tc-filter-mobile-badge">{hiddenCount} hidden</span>}
        </button>
