...
const CookiePolicyPage = () => (
  <div className="tc-policy-page">
    <div className="tc-policy-content">
      <Link to="/" className="tc-policy-back">← Back</Link>
      ...
      <p>
        Cookies are small text files stored in your browser when you visit a website. They are widely
        used to make sites work, or work more efficiently, and to provide information to site owners.
      </p>
      ...
      <table className="tc-policy-table">
        ...
        <tbody>
          <tr>
            <td><code>pa_cookie_consent</code></td>
      ...
      <h3>Analytics</h3>
      <p>
        If you accept analytics cookies, we use Google Tag Manager and Google Analytics to understand
        how visitors interact with the site — which pages are visited, how long sessions last, and
        similar aggregate statistics. No personal data is sold or shared with third parties.
      </p>
      ...
      <h2>Your choices</h2>
      <p>
        You can accept or decline analytics cookies using the banner shown on your first visit.
